...
const Section3 = forwardRef((props, ref) => (
  <section className="wrap product-section" id="section3" ref={ref}>
    <h2>튜터 소개</h2>
    <div className='wrap tutor'>
      <div className="profile">
        <div className='img-box'>
          <img src="profile.jpg" alt="펫공방 스튜디오 프로필 사진" className="profile-img" />
        </div>
        <div className="basic-info">
          <strong className="name">펫공방 스튜디오</strong>
          <div className="sns">
            <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer">@_petgram</a>
            <hr className="divider" />
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer">펫공방채널</a>
          </div>
        </div>
      </div>
